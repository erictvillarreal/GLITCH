...
### P&L tradicional 50K-B, caso mediano (21-sep-2026) — `dd_cash/pnl_50kb.py`
Extraído de la MISMA simulación (seed 11, 40,000 trayectorias, base 2 años, sin lags), sin modelo nuevo. Caso mediano = las 1000 trayectorias más cercanas a la trayectoria acumulada mediana (renglones aditivos). Año 1: ingresos (payouts) $10,566; egresos $4,170 (fees Combine $1,029, activación $2,601, Massive $522, Pi $18); utilidad neta $6,396 (mediana de todas las trayectorias: $6,783). Utilidad acumulada mediana: mes 1 −$390, mes 2 +$409 (cruce en el MES 2, no el 1: día 28 de trading = mes 2 con 21 días/mes). Pendiente estable ≈ $610/mes (cohorte, meses 4–12) / $652 (media de todas). p10 acumulada mes 12 $1,204; p90 $14,184. Inversión inicial ≈ $3,100 ($3,000 colchón + Pi ~$80–100; la 1ª fee de Combine de 50K es $49 y sale del colchón, no se suma).
